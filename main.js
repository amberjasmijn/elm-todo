...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{countTodos: 0, input: '', todos: _List_Nil, uid: 0},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$newTodo = F2(
	function (description, id) {
		return {completed: false, description: description, id: id};
	});
					...
					_Utils_update(
						model,
						{
							todos: _Utils_ap(
								...
								_List_fromArray(
									[
										A2(author$project$Main$newTodo, model.input, model.uid)
									])),
							uid: model.uid + 1
						}),
					elm$core$Platform$Cmd$none);
...
var author$project$Main$ToggleComplete = F2(
	function (a, b) {
		return {$: 'ToggleComplete', a: a, b: b};
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(author$project$Main$ToggleComplete, todo.id, !todo.completed)),
...
var author$project$Main$viewKeyedTodo = function (todo) {
	return _Utils_Tuple2(
		elm$core$String$fromInt(todo.id),
		author$project$Main$viewTodo(todo));
};
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					function (todo) {
						return author$project$Main$viewKeyedTodo(todo);
					},
					model.todos))
			]));
};
